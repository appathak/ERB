 ...
 double cnt1=0.0,points;
	...
	try{
		...
		String name=request.getParameter("name4");
	 	double percentage=Double.parseDouble(request.getParameter("per4"));
	 	String year=request.getParameter("yoc4");
	 	String school=request.getParameter("sn4");
...
String s = "select * from pg where uname = '"+str+"'";
String sql2 ="insert into pg values('"+cnt+"','"+str+"','"+name+"','"+percentage+"','"+year+"','"+school+"','"+points+"')";
